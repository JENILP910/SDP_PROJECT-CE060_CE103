...
const SignUp = () => {
	...
	const handleSubmit = async (e) => {
		...
		if (Object.keys(errors).length === 0) {
			try {
				setIsFetching(true);
				// const url = process.env.REACT_APP_API_URL + data.email;
				const url = key.apiurl + "/users/c/";
	...
	return (
		<div className={styles.container}>
			...
			<h1 className={styles.heading}>SignUp for free...</h1>
			{/* <Button
			...
			<form onSubmit={handleSubmit} className={styles.form_container}>
				...
				<div className={styles.checkbox_container}>
					<Checkbox
						...
						label="I agree my registration data credible."
					/>
				</div>
